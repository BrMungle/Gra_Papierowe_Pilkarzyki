...
class gracz_lewy:
    ...
    def stworz_siec(self):
        ...
        x = layers.Dense(40, activation="sigmoid", name="dense_1")(inputs)
        x = layers.Dense(30, activation="sigmoid", name="dense_2")(x)
        outputs = [layers.Dense(1, activation="tanh", name="predictions1")(x),
                   layers.Dense(1, activation="tanh", name="predictions2")(x),
                   layers.Dense(1, activation="tanh", name="predictions3")(x),
                   layers.Dense(1, activation="tanh", name="predictions4")(x),
                   layers.Dense(1, activation="tanh", name="predictions5")(x),
                   layers.Dense(1, activation="tanh", name="predictions6")(x),
                   layers.Dense(1, activation="tanh", name="predictions7")(x),
                   layers.Dense(1, activation="tanh", name="predictions8")(x)]
...
liczba_gier_do_rozegrania = 10000
for i in range(liczba_gier_do_rozegrania):
    eps = 1 - i/liczba_gier_do_rozegrania
    print('gra' + str(i))
    p_1 = plansza()
